...
public abstract class CnabRemessa {
	...
	protected BancoCarteira bancoCarteira;
	...
	protected String getCodigoMestre(int tamanho) {
		String codMestre = StringUtils.leftPad(bancoCarteira.getCodMestre(), tamanho, "0");
		return codMestre;
	}
	...
	protected String getIdentEmpresa(int tamanho) {
		String ident = "";
		ident = ident + StringUtils.leftPad(bancoCarteira.getCodCarteira(), 3, "0");
		ident = ident + StringUtils.leftPad(bancoCarteira.getAgencia(), 5, "0");
		ident = ident + StringUtils.leftPad(bancoCarteira.getConta(), 8, "0");
	...
	protected String calculoDigito(String nossoNumero) {
		...
		String numero = StringUtils.leftPad(bancoCarteira.getCodCarteira(), 2, "0");
