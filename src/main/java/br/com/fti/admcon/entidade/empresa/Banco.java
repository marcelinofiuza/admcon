package br.com.fti.admcon.entidade.empresa;
...
import br.com.fti.admcon.entidade.embeddeble.Contato;
import br.com.fti.admcon.entidade.embeddeble.Endereco;
...
public class Banco extends ZEmpresa implements Serializable {
	...
	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY)
	@JoinColumn(name = "idBanco")
	private List<BancoCarteira> carteiras = new ArrayList<BancoCarteira>();
	...
	public List<BancoCarteira> getCarteiras() {
		return carteiras;
	}

	public void setCarteiras(List<BancoCarteira> carteiras) {
		this.carteiras = carteiras;
	}

	public void addCarteira(BancoCarteira carteira) {
