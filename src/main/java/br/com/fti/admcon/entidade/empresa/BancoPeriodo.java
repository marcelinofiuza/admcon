...
public class BancoPeriodo extends ZEmpresa implements Serializable {
	...
	public void addLancamento(Lancamento bancoLcto) {
	...
	private void somaDebitoCredito() {
		...
		for (Lancamento lancamento : lancamentos) {
			if (lancamento.getTipoLcto() == DebitoCredito.DEBITO) {
				this.debito = this.debito.add(lancamento.getValorLcto());
			} else {
				this.credito = this.credito.add(lancamento.getValorLcto());
			}
		}
	}
