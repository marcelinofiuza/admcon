package br.com.fti.admcon.controleTela;
...
public class ControlePrincipal {
	...
	public Boolean authorityCheck(String role) {
		
		//String role = "ROLE_CONTA";
		
		for (UsuarioRoles usuarioRole : usuario.getRoles()) {
			if (usuarioRole.getRole().name().equals(role) ||
			    usuarioRole.getRole().name() == "ADMIN") {
				return true;
			}
		}
