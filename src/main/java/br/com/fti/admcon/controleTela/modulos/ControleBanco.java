...
import br.com.fti.admcon.modulos.entidades.empresa.BancoContatos;
...
public class ControleBanco implements Serializable {
	...
	private List<BancoCarteira> listaBancoCarteira;
	private BancoCarteira bancoCarteira = new BancoCarteira();
	...
	public void setListaBancoCarteira(List<BancoCarteira> listaBancoCarteira) {
		this.listaBancoCarteira = listaBancoCarteira;
	}

	public BancoCarteira getBancoCarteira() {
		return bancoCarteira;
	}

	public void setBancoCarteira(BancoCarteira bancoCarteira) {
